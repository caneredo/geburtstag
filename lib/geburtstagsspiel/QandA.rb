 questions = {
  'Frage 1' => '"Dä Behrendt wenn dä he her zum Dreh kütt, dann langt dä öbbern Tresen in ming Schüssel för ne Handvoll Fritten."',
  'Frage 2' => 'Weiter gehts zum alten Hauptzollamt.',
  'Frage 3' => 'Unser nächstes Ziel ist der Sitz der Europäischen Agentur für Flugsicherheit (EASA).',
  'Frage 4' => 'Sie wurde unter Kaiser Wilhelm im Jahr 1911 für 14 Millionen Mark erbaut.',
  'Frage 5' => 'Hier stand bereits 1544 das "Zum Kranz" eines der Beliebtesten in Köln.',
  'Frage 6' => 'Auf zum „mercatus coloniae“ (Bezeichnung im Jahr 922 und seit 988 das „forum“ des römischen Köln).',
  'Frage 7' => 'Zu Beginn und zum Ende der jecken Jahreszeit steht er im Mittelpunkt des Interesses.',
  'Frage 8' => 'Unser Ziel ist der Geburtsort zweier großer deutscher Fernsehstars'
 }
